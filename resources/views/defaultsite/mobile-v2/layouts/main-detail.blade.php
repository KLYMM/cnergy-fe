...
<body class="vh-text-md leading-normal bg-stone-100 font-primary-1 maverick-info">
    ...
    <header class="header fixed top-32 right-0 z-20 transition" data-header>
        <div class="switchTheme relative flex items-center rounded-tl-full rounded-bl-full h-12 px-3 bg-dark-0 transition opacity-50 hover:opacity-100">
            ...
            <label class="switchTheme-icon" for="switchTheme">
                <svg class="svg-both-white switchTheme-icon-dark" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="svg-stroke-white switchTheme-icon-light" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        for (var i = 0; i < lineclamp.length; i++) {
            ...
            if (strlength > maxlength) {
                ...
                lineclamp[i].innerHTML = visible + "<span class='dots'>...</span> <span class='more-text hidden'>" + hidden + "</span> <span class='dots-btn vh-text-sm font-semibold font-primary-1 block mt-4 cursor-pointer pointer-events-auto'>More</span> ";
            }
