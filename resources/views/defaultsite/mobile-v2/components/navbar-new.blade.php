...
$synopsis = $row['news_synopsis'];

?>

<header class="header fixed bottom-16 right-4 z-40 text-white transition dark:text-white" data-header="">
    <div class="flex flex-col items-center space-y-2">
        <a href="#" class="flex items-center justify-center rounded-full h-12 w-12 bg-dark-40 dark:bg-white-40"
            id="shareMenu">
        ...
        <a href="#" data-toggle="menu"
            class="flex items-center  justify-center rounded-full h-12 w-12 bg-dark-40 dark:bg-white-40">
            <svg width="18" height="16" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M0 0H18V2.25H0V0ZM0 6.25H18V8.5H0V6.25ZM18 12.5H3.5V14.75H18V12.5Z" fill="white"></path>
            </svg>
        </a>
    </div>
