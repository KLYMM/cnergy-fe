    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                ...
                <a href="{{ Src::detail($newsItem) }}" title="{{ $newsItem['news_title'] }}">
                    <h1 class="article-title vh-text-2xl font-outfit font-bold mb-2 animate animate--fadeInRight" style="--delay: 100ms">
                        {{ $newsItem['news_title'] }}
                    </h1>
                </a>
                <span class="article-date vh-text-xs text-primary dark:text-white-20 inline-block animate animate--fadeInLeft" data-date="{{ Util::date($newsItem['news_date_publish'], 'default_date') }}" data-hour="{{ Util::date($newsItem['news_date_publish'], 'default_hour') }}" data-author="{{ $newsItem['news_editor'][0]['name'] ?? '' }}" style="--delay: 200ms">{{ Util::date($newsItem['news_date_publish'], 'ago') }}
                </span>
            </div>
        ...
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp mb-6 " style="--delay: 400ms">
            <div class="article-footer-left flex-1 ">
                <a rel="nofollow" class="btn-baca btn btn--outline flex items-center rounded-lg justify-center vh-h-btn  font-outfit font-medium bg-primary-40  dark:bg-primary-41 dark:text-white" href="{{ Src::detail($newsItem) }}">
                    <span>READ MORE </span>
