        ...
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag inline-block font-nunito font-bold text-primary border border-primary dark:border-white-20 rounded-md py-0.5 px-2 dark:text-white-20 mb-2 animate animate--fadeInLeft"
                        style="--delay: 0ms">{{ $newsItem['news_tag'][0]['tag_name'] }}
                    </span>
                @endif
                <h1 class="article-title vh-text-3xl font-redhat font-bold mb-2 animate animate--fadeInRight"
                    style="--delay: 100ms">
                    {{ $newsItem['news_title'] }}
                </h1>
                <span
            ...
            <div class="article-asset mb-4">
                <figure class="article-asset w-full vh-h-landscape aspect-375 overflow-hidden">
                    <img class="object-cover w-full h-full animate animate--fadeIn rounded-xl" style="--delay: 300ms"
                        src="{{ $newsItem['news_image']['real'] }}" alt="{{ $newsItem['news_title'] }}" width="375"
                        height="225" />
                </figure>
            </div>
        </div>
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp" style="--delay: 400ms">
