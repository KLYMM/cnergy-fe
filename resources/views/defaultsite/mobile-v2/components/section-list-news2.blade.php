    ...
    <article class="article flex flex-col h-full px-6 mt-5">
            ...
            <a class="header-body-logo-link contents" href="/">
                @if ($logo = \Site::api('fe-setting') ?? null)
                    <img class="logo-section-3 icon-lg object-contain dark:img-white" alt="logo" width="140"
                        height="48" src="{{ $logo['data']['site_logo'] ?? null }}"  style="filter: invert(1) grayscale(2) brightness(100);
                        "/>
                @endif
            </a>
        </span>
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                ...
                <div class="flex items-center gap-3 text-white mt-3">
                    ...
                    @endif
                    <span class="article-date vh-text-xs  dark:text-white-20 inline-block animate animate--fadeInLeft"
            ...
            <div class="article-paragraph line-clamp-5 px-14  text-white  animate animate--fadeInUp"
                style="--delay: 300ms">
                <p class="vh-text-md">
        ...
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp mb-6 "
            ...
            <div class="article-footer-left flex-1 ">
                <a rel="nofollow"
                    class="btn-baca btn btn--outline flex items-center rounded-full justify-center vh-h-btn  font-outfit font-medium bg-pink  dark:bg-primary-41 dark:text-white"
                    href="{{ Src::detail($newsItem) }}">
                    <span>READ MORE </span>
                    <svg class="dark:svg-stroke-white ml-3" width="20" height="20" viewBox="0 0 24 24"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 12H22" stroke="var(--color-primary-2)" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M15 5L22 12L15 19" stroke="var(--color-primary-2)" stroke-width="2"
