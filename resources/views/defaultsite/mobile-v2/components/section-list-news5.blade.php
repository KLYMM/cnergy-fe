        ...
        <div class="article-main relative flex-1">
            <div class="article-asset mb-4">
                <figure class="article-asset w-full vh-h-landscape aspect-375 overflow-hidden">
                    <img class="object-cover w-full h-full animate animate--fadeIn rounded-xl" style="--delay: 400ms"
            ...
            <div class="article-background">
                ...
                <span
                    ...
                    style="--delay: 100ms">{{ $newsItem['news_date_publish'] }}</span>
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag block font-nunito font-bold text-primary dark:text-white-20 dark:border-white-20 border-t border-primary pt-2 mb-4 animate animate--fadeInLeft"
