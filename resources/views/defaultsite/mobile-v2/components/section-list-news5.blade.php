    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        <div class="article-main relative flex-1">
            ...
            <div class="article-background">
                <h1 class="article-title vh-text-2xl font-outfit font-bold mb-2 animate animate--fadeInUp" style="--delay: 0ms">{{ $newsItem['news_title'] }}
                </h1>
                <span class="article-date text-sm text-primary dark:text-white-20 mb-4 inline-block animate animate--fadeInUp" style="--delay: 100ms">{{ Util::date($newsItem['news_date_publish'], 'ago') }}
                </span>
        ...
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp mb-6 " style="--delay: 400ms">
            <div class="article-footer-left flex-1 ">
                <a class="btn btn--outline flex items-center justify-center vh-h-btn rounded-lg  font-outfit font-medium bg-primary-40  dark:bg-primary-41 dark:text-white" href="{{ Src::detail($newsItem) }}">
                    <span>READ MORE</span>
