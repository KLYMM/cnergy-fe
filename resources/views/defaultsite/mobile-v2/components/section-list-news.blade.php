<section>
    <div class="section-tag">
        <a href="#">
            <img class="logo-img dark-img-white" src="{{ URL::asset('assets/images/logo-lg.png') }}" width="132" height="41" />
        </a>
        ...
        <label class="switchTheme-icon" for="switchTheme">
            <svg class=" switchTheme-icon-dark" width="24" height="24" viewBox="0 0 24 24"
