    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        ...
        <div class="article-main relative flex-1">
            ...
            <div class="article-background ">
                ...
                <span class="article-tag block border-tag capitalize font-inter font-bold text-black border-black-60 pt-2 mb-2 animate animate--fadeInUp dark:text-white-20 dark:border-white-20" style="--delay: 0ms">
                    @if (Request::is('photo'))
                    {{ $tagPhoto }}
        ...
        <div class="article-footer flex justify-between items-center mb-6 animate animate--fadeInUp " style="--delay: 500ms">
            <div class="article-footer-left flex-1 ">
                <a rel="nofollow" class="btn-baca btn btn--outline  flex items-center justify-center vh-h-btn rounded-full  font-outfit font-medium bg-primary-40 dark:bg-primary-41 dark:text-white" href="{{ Src::detail($newsItem) }}">
