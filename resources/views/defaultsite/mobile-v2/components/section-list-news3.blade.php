        ...
        <div class="article-main relative flex-1">
            <div class="article-asset mb-4">
                <figure class="article-asset w-full vh-h-landscape aspect-375 overflow-hidden">
                    <img class="object-cover w-full h-full animate animate--fadeIn rounded-xl" style="--delay: 0ms"
            ...
            <div class="article-background">
                ...
                <span
                    class="article-date vh-text-xs text-primary-60 dark:text-white-20 mb-4 inline-block animate animate--fadeInLeft"
                    style="--delay: 200ms">{{ $newsItem['news_date_publish'] }}</span>
                <div class="article-paragraph line-clamp-5 text-primary-60 dark:text-white-20 mb-4 animate animate--fadeInUp"
                    style="--delay: 300ms">
                    <p>
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag font-nunito font-bold text-primary-60 border-t border-primary-60 block pt-2 dark:text-white-20 dark:border-white-20 animate animate--fadeInLeft"
                        style="--delay: 400ms">{{ $newsItem['news_tag'][0]['tag_name'] }}
                    </span>
                @endif
            </div>
        </div>
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp" style="--delay: 500ms">
            <div class="article-footer-left flex-1">
                <a class="btn btn--outline flex items-center justify-center vh-h-btn rounded-full font-nunito font-medium bg-yellow-40 dark:bg-black-40 dark:text-white-20"
                    ...
                    <svg class="dark:svg-stroke-white ml-2" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        <path d="M15 5L22 12L15 19" stroke="var(--color-black)" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </a>
            </div>
