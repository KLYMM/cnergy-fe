        ...
        <div class="article-main relative flex-1">
            ...
            <div class="article-background">
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag font-inter capitalize font-bold color-primary-41 border-t-2 border-primary-41 block pt-2 text-lg dark:text-white-20 dark:border-white-20 animate animate--fadeInLeft"
