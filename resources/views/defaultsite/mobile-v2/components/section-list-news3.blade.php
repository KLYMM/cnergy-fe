            ...
            <div class="article-background ">
                <a href="{{ Src::detail($newsItem) }}" title="{{ $newsItem['news_title'] }}">
                    <h1 class="article-title vh-text-2xl font-outfit font-bold mb-2 animate animate--fadeInRight"
                        style="--delay: 100ms">{{ $newsItem['news_title'] }}
                    </h1>
                </a>
                <span
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag block border-tag capitalize font-inter font-bold text-black border-black-60 pt-2 mb-2 animate animate--fadeInUp dark:text-white-20 dark:border-white-20"
                        style="--delay: 0ms">
                        @if (Request::is('photo'))
                            {{ $tagPhoto }}
