        ...
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                ...
                <span
                    ...
                    style="--delay: 100ms">{{ $newsItem['news_date_publish'] }}
                </span>
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag block font-nunito font-bold text-primary dark:text-white-20 dark:border-white-20 border-t border-primary pt-2 animate animate--fadeInLeft"
