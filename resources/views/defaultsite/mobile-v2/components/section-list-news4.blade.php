    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        ...
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                ...
                <span
                    class="article-date vh-text-xs text-primary-2 dark:text-white-20 mb-4 inline-block animate animate--fadeInLeft"
                ...
                @if (count($newsItem['news_tag']) > 0 ?? null)
                    <span
                        class="article-tag block border-tag capitalize font-inter font-bold text-primary-2  border-primary-2 pt-2 mb-2 animate animate--fadeInLeft dark:text-white-20 dark:border-white-20"
                        style="--delay: 0ms">
                        @if (Request::is('photo'))
                            {{ $tagPhoto }}
        ...
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp mb-6"
            ...
            <div class="article-footer-left flex-1 ">
                <a rel="nofollow"
                    class="btn-baca btn btn--outline flex items-center justify-center vh-h-btn rounded-full  font-outfit font-medium bg-pink  dark:bg-primary-41 dark:text-white"
