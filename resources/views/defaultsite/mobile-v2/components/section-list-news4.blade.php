    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        ...
        <div class="article-footer flex justify-between items-center animate animate--fadeInUp mb-6" style="--delay: 400ms">
            <div class="article-footer-left flex-1 ">
                <a rel="nofollow" class="btn-baca btn btn--outline flex items-center justify-center vh-h-btn rounded-lg  font-outfit font-medium bg-primary-40  dark:bg-primary-41 dark:text-white" href="{{ Src::detail($newsItem) }}">
                    <span>READ MORE</span>
