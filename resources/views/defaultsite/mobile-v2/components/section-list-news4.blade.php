    ...
    <article class="article flex flex-col h-full px-6 mt-5">
        <div class="article-main relative flex-1">
            <div class="article-background mb-4">
                <h1 class="article-title vh-text-2xl font-outfit font-bold mb-2 animate animate--fadeInUp" style="--delay: 0ms">
                    {{ $newsItem['news_title'] }}
                </h1>
                <span class="article-date vh-text-xs text-primary dark:text-white-20 mb-4 inline-block animate animate--fadeInUp" style="--delay: 100ms">{{ Util::date($newsItem['news_date_publish'], 'ago') }}
                </span>
