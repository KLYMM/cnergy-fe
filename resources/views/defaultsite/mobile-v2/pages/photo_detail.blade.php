                ...
                <div class="swiper-wrapper">
                    @if (count($row['photonews'] ?? []) > 0)
                        <div class="header-photo">
                            ...
                            <p class="photo-author pt-2">By <a style="color: #CA0000 ;"
                            ...
                            <div class="icons mt-2 " style="display: flex; ">
                                ...
                                <div>
                                    <a class="icons-share-a"
                                        ...
                                        target="_blank"><i class="icon icons--share icon--share-fb"><i
                                                class="fa-brands fa-wa fa-whatsapp" style="margin-left: 10px"></i></i></a>
                                </div>
                                <div>
                                    <a class="icons-share-a"
                                        ...
                                        target="_blank"><i class="icon icons--share icon--share-fb"><i
                                                class="fa-brands fa-twitter fa-twitter"
                                                style="margin-left: 10px"></i></i></a>
                                </div>
                                <div class="ms-3">
                                    {{-- <input type="text" id="copy-link" value={{ url()->current() }}> --}}
                                    <button class="icons-share-link px-2" value="copy" onclick="copyToClipboard()"> <i
                                            class="fa-solid fa-link mx-1"></i> Copy Link</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="icons mt-2 " style="display: flex; ">
                                        ...
                                        <div>
                                            <a class="icons-share-a"
                                                href="https://wa.me/?text={{ urlencode(url()->current() . '?utm_source=Mobile&utm_medium=whatsapp&utm_campaign=Share_Bottom') }}"
                                                target="_blank"><i class="icon icons--share icon--share-fb"><i
                                                        class="fa-brands fa-wa fa-whatsapp"
                                                        style="margin-left: 10px"></i></i></a>
                                        </div>
                                        <div>
                                            <a class="icons-share-a"
                                        ...
                                        <div class="ms-3">
                                            {{-- <input type="text" id="copy-link" value={{ url()->current() }}> --}}
                                            <button class="icons-share-link px-2" value="copy"
                                                onclick="copyToClipboard()"> <i class="fa-solid fa-link mx-1"></i> Copy
                                                Link</button>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="div-hidden" class="hidden-component">
                <div style="margin:20px;">
                    <button type="button" data-toggle="modal" data-target="#myModal"
                        class="btn btn-light report-btn"><i class="fa-solid fa-triangle-exclamation"
                            style="color: #ca0000; margin-right: 10px;"></i>REPORT
                        ARTICLE</button>
                ...
                @include('defaultsite.mobile.components-ui.related-news', [
                    'news' => $row['latest'],
                    'title' => 'LATEST NEWS',
                ])
