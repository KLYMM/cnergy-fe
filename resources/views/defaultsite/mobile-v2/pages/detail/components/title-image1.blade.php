<section data-section="sectionTitleImg1" class="section section--dt snap-always snap-start w-full h-full flex flex-col shrink-0 transition dark:bg-dark-3 dark:text-white " data-theme="highlight2" data-template="readpage-TitleImageCase1">
