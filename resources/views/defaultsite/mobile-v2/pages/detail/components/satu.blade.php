...
<section data-section="section1"
    ...
    <div class="section-body relative flex flex-col h-full">
        <a class="header-body-logo-link" href="/">
            <span class="header-body-logo-link-icon absolute pl-6 mt-5 z-10 animate animate--fadeInUp" style="--delay: 200ms">
        ...
        <div class="dt relative overflow-hidden flex-1">
            ...
            <div class="dt-desc relative z-10 px-6">
                ...
                <p class="dt-desc-clone animate animate--fadeInUp" style="--delay: 300ms"><span
                        class="rounded-full bg-light-1 dark:bg-dark-1 font-medium">{{ $row['news_tag'][0]['tag_name'] ?? null }}</span>
                </p>
