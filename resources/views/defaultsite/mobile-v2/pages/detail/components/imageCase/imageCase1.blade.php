<section data-section="section1" class="section section--dt snap-always snap-start w-full h-full flex flex-col shrink-0 transition bg-light-1 text-white dark:bg-dark-1 " data-theme="story1">
