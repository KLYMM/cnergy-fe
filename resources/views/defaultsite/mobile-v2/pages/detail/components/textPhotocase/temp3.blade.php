<section data-section="section3"
    ...
    <div class="section-body mt-5 relative overflow-hidden flex-1 container max-w-full">
        <article class="article relative overflow-hidden flex flex-col h-full px-6">
            <div class="dt-paragraph article-paragraph layout-down font-inter text-dark7  text-xs leading-7 mx-1.5 font-normal  line-clamp-2 animate animate--fadeInUp"
                style="--delay: 100ms; position:absolute;">
                ...
                <div class="btn-inner btn-inner-photo mx-1.5" onclick="readMoreButtonDown()"></d>
            </div>
            <div class="article-main relative flex-1 ">
                <div class="article-desc relative z-20">
                    <div class="article-asset relative -mx-4 mb-6 animate animate--fadeInUp" style="--delay: 200ms; z-index:-1;">
                        <figure
                            class="article-asset mx-4 w-full bg-cover bg-no-repeat bg-center overflow-hidden"
                            style="background-image: url('{{ $row['news_image']['real'] }}'); height: 380px; width:300px; margin:auto;" style="z-index:-1">
