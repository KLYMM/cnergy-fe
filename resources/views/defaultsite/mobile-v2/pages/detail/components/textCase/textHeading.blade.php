<section data-section="sectionHeading" class="section snap-always snap-start w-full h-full shrink-0 transition bg-light-8 text-black dark:bg-dark-0 dark:text-white {{ ($loop->last) ? 'last' : '' }}" data-theme="dt-text-3">
