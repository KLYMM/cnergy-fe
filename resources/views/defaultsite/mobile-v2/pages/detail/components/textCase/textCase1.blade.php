<section data-section="sectionSatu" class="section snap-always snap-start w-full h-full shrink-0 transition {{ $chunk['template']['bg_theme'] }} {{ ($chunk['template']['bg_theme'] == 'bg-light-2') ? 'text-white' : 'text-black' }} dark:bg-dark-0 dark:text-white" data-theme="dt-text-1">
    <div class="section-body relative flex flex-col h-full">
        <div class="dt relative overflow-hidden flex-1">
            ...
            <span class="absolute bottom-0 right-0 px-2 animate animate--fadeIn" style="--delay: 0ms">
