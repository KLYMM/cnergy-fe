<section data-section="sectionSatu" class="section snap-always snap-start w-full h-full shrink-0 transition {{ $chunk['template']['bg_theme'] }} text-black dark:bg-dark-0 dark:text-white" data-theme="dt-text-1">
