<section data-section="sectionDua{{ $loop->iteration }}" class="section section--dt snap-always snap-start w-full h-full shrink-0 transition bg-light-0 text-black dark:bg-dark-0 dark:text-white {{ ($loop->last) ? 'last' : '' }}"" data-theme=" dt-text-1" data-template="Info-Story-Text-Plain-V1">
