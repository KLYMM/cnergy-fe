<section data-section="section5" class="section snap-always snap-start w-full h-full flex flex-col shrink-0 transition {{ $chunk['template']['bg_theme'] }} text-black dark:bg-dark-3 dark:text-white pt-16" data-theme="highlight2">
            ...
            <div class="article-main relative flex-1">
                <div class="article-desc flex relative pr-12 z-20">
                    <div class="article-desc-highlight relative">
                        <!-- <h1 class="article-title pl-8 vh-text-lg font-semibold mb-6 animate animate--fadeInUp"
                            style="--delay: 0ms">"Menteri Dalam Negeri Korsel, Lee Sang-min ditetapkan sebagai terdakwa
                            dalam kasus tragedi Halloween di Itaewon, Seoul. Kepolisian Korea Selatan (Korsel)
                            mengatakan bahwa pihaknya akan mendakwa Menteri Dalam Negeri Korsel, Lee Sang-min atas
                            dugaan melalaikan tugas dan melakukan kelalaian profesional yang mengakibatkan 158 orang
                            tewas dalam tragedi maut tersebut.
                        </h1> -->
