<section data-section="sectionDua" class="section snap-always snap-start w-full h-full shrink-0 transition {{ $chunk['template']['bg_theme'] }} {{ ($chunk['template']['bg_theme'] == 'bg-light-2') ? 'text-white' : 'text-black' }} dark:bg-dark-0 dark:text-white" data-theme="dt-text-1">
