            ...
            <div class="article-main relative flex-1">
                <div class="article-desc flex relative pr-12 z-20">
                    <div class="article-desc-highlight ">
                        <div class="flex">
                            <span
                                    class="absolute top-3 left-0 w-8 border-t-4 color-primary border-current  animate animate--fadeInUp"
                                    style="--delay: 100ms"></span>
                                <div class="article-paragraph font-inter text-dark7 line-clamp-9 animate animate--fadeInUp"
                                    style="--delay: 200ms">
                                    <h1 class="article-title text-2xl text-dark7 ml-16 font-bold">Funny black good morning quotes can be references and ideas</h1>
                                </div>  

                        </div>
                        {{-- <h1 class="article-title vh-text-xl font-semibold mb-6 animate animate--fadeInUp"
                            style="--delay: 0ms">"Ada 2 WNI yang jadi korban tragedi Itaewon. Namun perlu kita syukuri
                            bahwa mereka telah kembali ke rumah masing-masing" <br>Gandi Sulistiyanto Duta Besar RI
                            untuk Korea Selatan</h1> --}}
                        <div class="article-desc relative">
                            <div class="article-paragraph font-inter text-dark7 mt-5 text-xl font-normal  line-clamp-2 animate animate--fadeInUp"
                                style="--delay: 100ms">
                                <p>Baseball is a very popular sport in many countries. This sport has millions of fans across the world. For all baseball lovers, you should check out this collection of the best baseball quotes funny The best way to enjoy your free time is to read some silly jokes. Especially jokes about something that you like. </p>
                            </div>
                        </div>
                    </div>
                </div>
